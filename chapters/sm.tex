...
The Dokshitzer-Gribov-Lipatov-Altarelli-Parisi (DGLAP) equations, which describe how PDFs depend on $Q^2$, can then be used to determine the \textit{global} PDFs~\cite{sm-dglap}.
