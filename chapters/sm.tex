...
As can be seen in figure~\ref{fig:sm_qcd_coupling}, perturbation theory begins to fail at energies less than $1~GeV$.
...
was confirmed by the discovery of $125~GeV$ Higgs boson by ATLAS and CMS in 2012~\cite{sm-higgs-discovery-atlas,sm-higgs-discovery-cms}.
...
If these primordial black holes exist in large enough quantities to account for the majority of dark matter in the universe,
they could in principle be detected in gravitational lensing surveys.
...
Dark matter in the form of MACHOs with masses greater than $10^{-7}$ solar masses have been ruled out entirely~\cite{sm-macho-dark-matter}.
