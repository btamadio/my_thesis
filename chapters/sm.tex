...
\begin{equation}\label{eq:higgs_kinetic}
    \Delta\mathcal{L} = \left(D_{\mu}\phi\right)^{\dagger}\left(D_{\mu}\phi\right)
...
Through SSB, electroweak gauge boson masses have been generated without requiring explicity mass terms in the Lagrangian.
