...
Small-R jets are used to indentify b-jets in events, which can then be
matched to large-R jets. To be considered for b-tagging, a small-R jet
must have $p_{T}>50~GeV$ and $|\eta|<2.5$. The algorithm used to tag
b-jets is described in chapter \ref{chapter-jets} as well as
\cite{b-jet-perf-1, b-jet-perf-2}



\section{Control, Validation, and Signal Regions} \label{region_defs}
