...
\subsubsection{Topo-cluster calibration}{subsubsec:topo_calibration}
\subsubsubsection{Hadronic and electromagnetic responses}\label{subsubsubsec:hadronic_electromagnetic}
...
\subsubsubsection{Out-of-cluster}\label{subsubsubsec:out_of_cluster}
...
\subsubusbsection{Dead material}\label{subsubsubsec:dead_material}
...
After calibration, the jet clustering algorithms can be run on the topo clusters according the procedures decribed
in~\ref{sec:jet_clustering}.

After jet clustering, further calibration is required on the resulting jets in ord
