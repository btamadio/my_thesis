...
\begin{figure}[h!]
    \centering
\includegraphics[width=0.6\linewidth]{jet_collinear_safety}
...
\begin{figure}[h!]
    \centering
\includegraphics[width=0.6\linewidth]{jet_ir_safety}
...
and consist of the $k_T$ algorithm, Cambridge-Aachen (C/A), and anti-$k_T$ algorithm.
