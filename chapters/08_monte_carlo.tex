...
For the analysis described in this thesis, full simulation events for the decay modes described in chapter~\ref{ch:analysis_overview} were not available, but a very similar signal was used.
...
Background estimation for this analysis was done with a fully data-driven method that does not rely on Monte Carlo to make predictions.
